    ...
    <form class="panel__section" novalidate @submit.prevent="submit">
        <div class="u-grid u-grid--small u-grid--vertical-margin--small">
            ...
            <div class="u-cell u-cell--xlarge--1-2">
                <FieldQr v-model="form.rewardAddress" :$value="$v.form.rewardAddress" :label="$td('Reward Address', 'form.masternode-reward-address')"/>
            ...
            <div class="u-cell u-cell--xlarge--1-2">
                <FieldQr v-model="form.ownerAddress" :$value="$v.form.ownerAddress" :label="$td('Owner Address', 'form.masternode-owner-address')"/>
