export default {
    ...
    hub: {
        ...
        'warning-description': 'Эта страница предназначена для внутреннего тестирования. Кросс-чейн переводы через Minter Hub находится в статусе альфа-версии. Вы несете единоличную ответственность за все операции с вашими активами и можете полностью их потерять, используйте этот функционал на свой страх и риск.',
        'warning-description-2': 'Minter Hub имеет открытый',
        'warning-description-3': 'исходный код',
        'warning-description-4': 'Изучите его при необходимости перед использованием предложенных на этой стрнице функций.',
    },
    form: {
