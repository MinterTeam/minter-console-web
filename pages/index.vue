    ...
    export default {
        ...
        fetch({app, store, redirect }) {
            if (store.getters.isAuthorized) {
                ...
                return redirect(app.i18nGetPreferredPath('wallet'));
            } else {
        ...
        head() {
            ...
            return {
                ...
                meta: [
                    ...
                    { hid: 'og-image', name: 'og:image', content: `${this.BASE_URL_PREFIX}/social-share${localeSuffix}.png` },
                ],
            };
        },
        data() {
        ...
        watch: {
            isAuthorized(newVal) {
                if (newVal) {
                    return this.$router.replace(this.$i18nGetPreferredPath('wallet'));
                }
            },
        },
        created() {
    ...
    <main>
                        ...
                        <div class="panel">
                            <div class="panel__header">
                                <h1 class="panel__header-title">
                                    <img class="panel__header-title-icon" :src="`${BASE_URL_PREFIX}/img/icon-auth-sign-in.svg`" alt="" role="presentation" width="40" height="40">
                            ...
                            <div class="panel__header">
                                <h1 class="panel__header-title">
                                    <img class="panel__header-title-icon" :src="`${BASE_URL_PREFIX}/img/icon-auth-register.svg`" alt="" role="presentation" width="40" height="40">
                                ...
                                <div class="u-grid u-grid&#45;&#45;small u-grid&#45;&#45;vertical-margin&#45;&#45;small">
                                    <div class="u-cell">
                                        <button class="button button&#45;&#45;main button&#45;&#45;full button&#45;&#45;trezor">
                                            <img class="button&#45;&#45;trezor__icon" :src="`${BASE_URL_PREFIX}/img/icon-auth-trezor.svg`" alt="" role="presentation">
                                            Sign In with
                                            <img class="button&#45;&#45;trezor__logo" :src="`${BASE_URL_PREFIX}/img/icon-auth-trezor-logo.svg`" alt="Trezor">
                                        </button>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="u-section u-container u-container--medium">
            ...
            <ul class="features__list u-grid u-grid--vertical-margin--large no-list">
                ...
                <li class="features__item u-cell u-cell--medium--1-2">
                    <img class="features__icon" :src="`${BASE_URL_PREFIX}/img/icon-feature-vote.svg`" alt="" role="presentation">
                    <div>
                ...
                <li class="features__item u-cell u-cell--medium--1-2">
                    <img class="features__icon" :src="`${BASE_URL_PREFIX}/img/icon-feature-account.svg`" alt="" role="presentation">
                    <div>
                ...
                <li class="features__item u-cell u-cell--medium--1-2">
                    <img class="features__icon" :src="`${BASE_URL_PREFIX}/img/icon-feature-support.svg`" alt="" role="presentation">
                    <div>
