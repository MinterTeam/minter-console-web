...
describe('index page', () => {
    /** @type {ItConcurrent} */
    const testnetOnly = NETWORK === TESTNET ? test : test.skip;
    ...
    testnetOnly('register new user and redirect to wallet', async () => {
        // console.log({user});
    ...
    testnetOnly('logout and redirect to auth form', () => {
        return logout(page);
    });

    testnetOnly('login and redirect to wallet', async () => {
